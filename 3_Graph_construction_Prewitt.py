...
#working directories
Normal_dir = '/home/linh/Downloads/CXR/Prewitt_v2_preprocessed_data/normal'
Bac_dir    = '/home/linh/Downloads/CXR/Prewitt_v2_preprocessed_data/bacterial'
Vir_dir    = '/home/linh/Downloads/CXR/Prewitt_v2_preprocessed_data/virus'


#generate_graph_with_labels(Bac, 1, activity_map)
process_graphs(Bac_dir, 
               Normal_dir, 
               Vir_dir,  
               activity_map)
...
save_dataframe_to_txt(df_A, sourcepath + '/CXR_Prewitt_v2_A.txt')
save_dataframe_to_txt(df_graph_indicator, sourcepath + '/CXR_Prewitt_v2_graph_indicator.txt')
save_dataframe_to_txt(df_graph_label, sourcepath + '/CXR_Prewitt_v2_graph_labels.txt')
save_dataframe_to_txt(df_node_attr, sourcepath + '/CXR_Prewitt_v2_node_attributes.txt')
save_dataframe_to_txt(df_node_label, sourcepath + '/CXR_Prewitt_v2_node_labels.txt')
